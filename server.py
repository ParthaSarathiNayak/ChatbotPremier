...
class Server:
    ...
    def __init__(self, model_directory, interpreter, core_endpoint_config):
        self.model_directory = model_directory
        self.interpreter = interpreter
        self.core_endpoint_config = core_endpoint_config
        self.agent = self._create_agent(model_directory, interpreter, core_endpoint_config)

    @staticmethod
    def _create_agent(model_directory, interpreter, core_endpoint_config):
        """Creates a Rasa Agent which runs when the server is started"""
        try:
            return Agent.load(model_directory, interpreter, action_endpoint = core_endpoint_config)
...
if __name__ == "__main__":
    ...
    server = Server("models/dialogue", RasaNLUInterpreter("models/nlu/default/nlu_model"), core_endpoint_config)
